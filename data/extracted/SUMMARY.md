...
- Later the same day the rule was generalised (same handover, section 6): **every** anticipated rank is `v1 * k` unless the Classic match is an exact same-name talent with the same rank count and the same rank 1, which is copied verbatim. Classic's offset is never re-based; 6 further talents changed value (priest Twilight Focus 23/40.25/57.5 -> 23/46/69, both Flurries 5/7.5/10/12.5/15 -> 5/10/15/20/25, mage Improved Cone of Cold and warrior Improved Rend 12/20/28 -> 12/24/36, mage Improved Blizzard 15/15/15 `manual` -> 15/30/45 `classic-prior`).
